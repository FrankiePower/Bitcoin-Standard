          ...
          <div className="flex-1 w-full space-y-6">
              ...
              <div className="flex-1 bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
                ...
                <div className="bg-[#fcf8f3]/50 border border-[#f97316]/20 rounded-[16px] p-4 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-[20px] font-medium text-neutral-300">
                      0
                    </div>
            ...
            <div className="bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
              ...
              <div className="w-full relative pt-6 pb-2">
                ...
                <div className="h-3 w-full bg-neutral-100 rounded-full flex overflow-hidden">
                  <div
                    className="h-full bg-emerald-100 relative"
                    style={{ width: "30%" }}
                  >
            ...
            <div className="relative overflow-hidden bg-[#1a1226] text-white rounded-[20px] p-8 md:p-12 shadow-md mt-4">
              ...
              <div className="absolute inset-0 pointer-events-none opacity-50">
                ...
                >
                  <path
                    d="M 0 200 Q 250 50 500 200"
                    stroke="#f43f5e"
                    strokeWidth="2"
                    fill="none"
                  />
                  <path
                    d="M 0 200 Q 250 80 500 200"
                    stroke="#f43f5e"
                    strokeWidth="1"
                    fill="none"
                  />
                  <path
                    d="M 0 200 Q 250 110 500 200"
                    stroke="#f43f5e"
                    strokeWidth="0.5"
                    fill="none"
                  />
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <div className="flex items-center gap-2 mb-8 bg-black/40 p-2 rounded-full border border-white/5">
                  <div className="w-8 h-8 rounded-full bg-[#f97316] flex items-center justify-center p-1.5 z-40">
                    <Image
                      src="/bitcoin-btc-logo.svg"
                      alt="BTC"
                      width={20}
                  ...
                  <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center p-1.5 -ml-4 z-30 ring-2 ring-[#1a1226]">
                    <span className="font-bold text-[10px]">ETH</span>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center -ml-4 z-20 ring-2 ring-[#1a1226]">
