...
export default function BorrowPage() {
  ...
  const handleMaxRepay = () => {
    const maxRepay =
      btsusdBalance < position.debt ? btsusdBalance : position.debt;
    setBorrowAmount((Number(maxRepay) / Number(BTSUSD_DECIMALS)).toFixed(2));
  };

  const handleMaxWithdraw = () => {
    setDepositAmount(
      (Number(maxWithdrawable) / Number(WBTC_DECIMALS)).toFixed(8),
    );
  };
        ...
        <div className="flex flex-col lg:flex-row gap-6 relative z-10 items-start">
          ...
          <div className="flex-1 w-full space-y-6">
              ...
              <div className="flex-1 bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
                ...
                <div className="bg-[#fcf8f3]/50 border border-[#f97316]/20 rounded-[16px] p-4">
                  ...
                  <div className="text-[12px] text-neutral-400 text-right">
                    $
                    {(Number(depositAmount || 0) * btcPriceUSD).toLocaleString(
                      undefined,
                ...
                <div className="mt-3 text-[12px] text-neutral-500">
                  Collateral: {formatWBTC(position.collateral)} wBTC ($
              ...
              <div className="flex-1 bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
                ...
                <div className="bg-[#fcf8f3]/50 border border-[#f97316]/20 rounded-[16px] p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      onClick={
                        activeTab === "repay" ? handleMaxRepay : handleMaxMint
                      }
                      className="text-[12px] text-orange-500 hover:text-orange-600 font-semibold"
                    >
                      MAX
                  ...
                  <div className="text-[12px] text-neutral-400 text-right">
                    $
                    {Number(borrowAmount || 0).toLocaleString(undefined, {
                      maximumFractionDigits: 2,
                    })}
                  </div>
                </div>
                ...
                <div className="mt-3 text-[12px] text-neutral-500">
                  Debt: {formatBTSUSD(position.debt)} BTSUSD | Max mintable:{" "}
                  {formatBTSUSD(maxMintable)}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
              <div className="flex justify-between items-start mb-6 w-full">
                ...
                <div className="text-right">
                  <div
                    className={`text-[18px] font-bold mb-1 flex items-center gap-2 justify-end ${getHealthColor()}`}
                  >
                    {getHealthIcon()}
              ...
              <div className="w-full relative pt-6 pb-2">
                ...
                <div className="flex justify-between mt-3 text-[10px] font-bold text-neutral-400 uppercase tracking-widest px-2">
                  <span className={currentLTV < 33 ? "text-emerald-600" : ""}>
                    Conservative
                  </span>
                  <span
                    className={
                      currentLTV >= 33 && currentLTV < 50
                        ? "text-amber-600"
                        : ""
                    }
                  >
                  ...
                  <span
                    className={
                      currentLTV >= 50 && currentLTV < 66.67
                        ? "text-amber-600"
                        : ""
                    }
                  >
                  ...
                  <span className={currentLTV >= 66.67 ? "text-red-600" : ""}>
                    Liquidation
                  </span>
                </div>
              </div>
            ...
            {position.collateral > BigInt(0) && (
              <div className="bg-white border border-neutral-100 rounded-[20px] p-6 shadow-sm">
                <h3 className="text-[18px] font-bold tracking-tight mb-4">
                  Your Position
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <div className="text-[16px] font-bold">
                      {formatWBTC(position.collateral)} wBTC
                    </div>
                  ...
                  <div>
                    ...
                    <div className="text-[16px] font-bold">
                      {formatBTSUSD(position.debt)} BTSUSD
                    </div>
                    <div className="text-[12px] text-neutral-400">
                      $
                      {(
                        Number(position.debt) / Number(BTSUSD_DECIMALS)
                  ...
                  <div>
                    ...
                    <div
                      className={`text-[16px] font-bold ${getHealthColor()}`}
                    >
                  ...
                  <div>
                    ...
                    <div
                      className={`text-[16px] font-bold flex items-center gap-1 ${getHealthColor()}`}
                    >
                      {getHealthIcon()}
                      {healthStatus === "none"
                        ? "No debt"
            ...
            <div className="mt-4">
              {!isConnected ? (
                ...
                <button
                  ...
                  disabled={
                    depositAmountBigInt === BigInt(0) || isDepositingCollateral
                  }
                ...
                <button
                  ...
                  disabled={
                    depositAmountBigInt === BigInt(0) ||
                    isWithdrawingCollateral ||
                    depositAmountBigInt > maxWithdrawable
                  }
                  className="w-full py-4 rounded-[20px] text-[17px] font-bold text-white transition-all hover:opacity-90 active:scale-[0.98] shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    background:
                ...
                <button
                  onClick={handleMint}
                  disabled={
                    borrowAmountBigInt === BigInt(0) ||
                    isMintingBTSUSD ||
                    borrowAmountBigInt > maxMintable
                  }
                  className="w-full py-4 rounded-[20px] text-[17px] font-bold text-white transition-all hover:opacity-90 active:scale-[0.98] shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    background:
                ...
                <button
                  ...
                  disabled={
                    borrowAmountBigInt === BigInt(0) ||
                    isBurningBTSUSD ||
                    borrowAmountBigInt > btsusdBalance
                  }
                  className="w-full py-4 rounded-[20px] text-[17px] font-bold text-white transition-all hover:opacity-90 active:scale-[0.98] shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    background:
          ...
          <div className="w-full lg:w-[320px] shrink-0 space-y-4">
            ...
            <div className="bg-[#1c1c1e] text-white rounded-[20px] p-6 shadow-lg relative overflow-hidden">
              ...
              <div
                className="text-[42px] font-bold tracking-tight text-white relative z-10"
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-[13px] font-bold">
                    {formatWBTC(totalCollateral)} wBTC
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[13px] text-neutral-500">
