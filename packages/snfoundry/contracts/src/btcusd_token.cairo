...
///
/// ERC20 stablecoin minted against native Bitcoin collateral held in OP_CAT vaults.
/// Only CDPCore can mint and burn; the owner can pause in emergencies.

#[starknet::contract]
pub mod BTCUSDToken {
    use contracts::interfaces::IBTCUSDToken;
    ...
    struct Storage {
        ...
        /// Only this address (CDPCore) may call mint / burn.
    ...
    fn constructor(ref self: ContractState, owner: ContractAddress, vault: ContractAddress) {
        self.erc20.initializer("Bitcoin USD", "BTCUSD");
